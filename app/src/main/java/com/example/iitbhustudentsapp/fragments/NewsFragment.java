...
import com.example.iitbhustudentsapp.adapters.NotificationsAdapter;
 ...
 * Fragment for News.
 */
public class NewsFragment extends Fragment implements Urls {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        newsRefreshLayout.setColorSchemeResources(R.color.colorPrimary, R.color.colorPrimaryDark,
                R.color.colorAccent);
