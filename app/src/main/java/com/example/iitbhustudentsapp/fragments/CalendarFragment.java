...
import com.example.iitbhustudentsapp.activities.MainActivity;
...
public class CalendarFragment extends Fragment implements RobotoCalendarView.RobotoCalendarListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        robotoCalendarView.markCircleImage1(new Date(1548681677570l));
        robotoCalendarView.markCircleImage2(new Date(1548681677570l));
        return rootView;
    }
